document.addEventListener("DOMContentLoaded", function() {
    const words = {
        button1: ["The King", "Aunt", "Uncle", "The dog", "My servent", "The lion", "The parrot"],
        button2: ["Sat on", "gone to", "lived with", "saw", "doesn't", "ate"],
        button3: ["a thin", "a scary", "a dirty", "a slimy", "a barking", "a fat"],
